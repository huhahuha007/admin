...
@param {...*} data
*/
Console.prototype.group = function(data) {};
/**
@param {...*} data
*/
Console.prototype.groupCollapsed = function(data) {};
...
Console.prototype.dirxml = function(object) {};
/**
@param [profileName]
*/
...
@param [profileName]
*/
Console.prototype.profileEnd = function(profileName) {};
/**
@interface
*/
function Console() {}
...
@browser Gecko
*/
CSSStyleDeclaration.prototype.mozOsxFontSmoothing = 0 || '';
/**
@browser Gecko
*/
...
@browser Gecko
*/
CSSStyleDeclaration.prototype.mozTextSizeAdjust = 0 || '';
/**
@browser Gecko
*/
...
@browser IE
*/
CSSStyleDeclaration.prototype.msTouchAction = 0 || '';
/**
@browser IE
*/
...
@browser Safari
*/
CSSStyleDeclaration.prototype.webkitBackdropFilter = 0 || '';
...
CSSStyleDeclaration.prototype.webkitFilter = 0 || '';
...
@browser Safari
*/
CSSStyleDeclaration.prototype.webkitOverflowScrolling = 0 || '';
...
@browser Safari
*/
CSSStyleDeclaration.prototype.webkitScrollSnapType = 0 || '';
/**
@browser Safari
*/
...
CSSStyleDeclaration.prototype.composes = 0 || '';
...
@browser Safari
*/
CSSStyleDeclaration.prototype.initialLetter = 0 || '';
CSSStyleDeclaration.prototype.initialLetterAlign = 0 || '';
CSSStyleDeclaration.prototype.initialLetterWrap = 0 || '';
...
CSSStyleDeclaration.prototype.scrollPadding = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingBlock = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingBlockEnd = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingBlockStart = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingBottom = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingInline = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingInlineEnd = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingInlineStart = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingLeft = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingRight = 0 || '';
CSSStyleDeclaration.prototype.scrollPaddingTop = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapAlign = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMargin = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginBlock = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginBlockEnd = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginBlockStart = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginBottom = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginInline = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginInlineEnd = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginInlineStart = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginLeft = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginRight = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapMarginTop = 0 || '';
CSSStyleDeclaration.prototype.scrollSnapStop = 0 || '';
...
CSSStyleDeclaration.prototype.willChange = 0 || '';
